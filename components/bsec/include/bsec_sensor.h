...
/* sensor_hub uniform-driver handle — a decorator over the BME680 raw data that
 * exposes BSEC's heat-compensated T/H/P plus gas_resistance, CO2-equivalent,
 * IAQ and VOC. Register with sensor_hub only when bsec_sensor_is_active(). */
