...
void ui_settings_create(void)
{
    ...
    if (bmx280_get_type() == BMX280_TYPE_BME680) {
        ...
        lv_obj_align(toff_hdr, LV_ALIGN_TOP_LEFT, 10, 496 + units_extra_y + ha_extra_y);
        ...
        lv_obj_align(toff_row, LV_ALIGN_TOP_MID, 0, 514 + units_extra_y + ha_extra_y);
    ...
    lv_obj_align(ota_btn, LV_ALIGN_TOP_MID, 0, 496 + units_extra_y + ha_extra_y + bme680_extra_y);
    ...
    /* ── Device Info section ─────────────────────────────────────────── */
    int info_y = 542 + units_extra_y + ha_extra_y + bme680_extra_y;
