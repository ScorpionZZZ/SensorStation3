...
void ui_settings_create(void)
{
    ...
    if (bmx280_get_type() == BMX280_TYPE_BME680) {
        ...
        lv_obj_align(toff_hdr, LV_ALIGN_TOP_LEFT, 10, 496);
        ...
        lv_obj_align(toff_row, LV_ALIGN_TOP_MID, 0, 514);
    ...
    lv_obj_align(ota_btn, LV_ALIGN_TOP_MID, 0, 496 + bme680_extra_y);
    ...
    case BMX280_TYPE_BME680: sensor_name = "BME680"; break;
    case BMX280_TYPE_BME280: sensor_name = "BME280"; break;
    case BMX280_TYPE_BMP280: sensor_name = "BMP280"; break;
    default:                 sensor_name = "Not connected"; break;
    }
    lv_label_set_text(sensor_val, sensor_name);
    lv_obj_set_style_text_color(sensor_val,
        bmx280_get_type() == BMX280_TYPE_NONE
