...
/* true when a BMx280 sensor was detected at boot; false hides the sensor
 * panels behind an error card and skips all sensor_history_* calls (its
 * mutex is never created when sensor_history_init() didn't run). */
...
void ui_main_create(void)
{
    ...
    bool sensor_present = (bmx280_get_type() != BMX280_TYPE_NONE);
