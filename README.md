...
- **Built-in touchscreen dashboard** running on an ESP32 CYD (Cheap Yellow Display) board:
...
- **MQTT integration** with [ThingsBoard](https://thingsboard.io/) and [Domoticz](https://www.domoticz.com/)
...
| BME680 (without BSEC) | Temperature, humidity, pressure, CO2-equivalent based on sensor resistance | ✅ Supported |
| BME680 (with BSEC) | Temperature, humidity, pressure, IAQ / CO2-equivalent                      | ✅ Supported — requires the proprietary Bosch BSEC library, see [Building with BSEC](#building-with-bsec) |
...
- **Board:** [ESP32 CYD](https://github.com/witnessmenow/ESP32-Cheap-Yellow-Display) (ESP32 with an integrated TFT touchscreen)
...
2. Still in Settings, configure timezone, MQTT/ThingsBoard/Domoticz connection, and sensor options.
